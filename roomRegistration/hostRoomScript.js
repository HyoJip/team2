...
function first_check_ok() {
  ...
  if (document.form.r_city.value == "") {
    alert("숙소 지역을 입력해주세요");
    form.r_city.focus();
    return;
  }
  if (document.form.r_address1.value == "") {
    alert("주소를 입력해주세요");
  ...
  if (document.form.r_bedrooms.value == "") {
    alert("방 갯수를 입력해주세요");
  ...
  if (document.form.r_check_in.value == "") {
    alert("희망 체크인 시간을 입력해주세요");
    form.r_check_in.focus();
    return;
  }
  if (document.form.r_check_in.value.length != 2) {
    alert("시간은 2자리로 입력해주세요 \n ex) 오전2시 = 02 , 오후3시 = 15");
    form.r_check_in.focus();
    return;
  }
  if (document.form.r_check_out.value == "") {
    alert("희망 체크아웃 시간을 입력해주세요");
    form.r_check_out.focus();
    return;
  }
  if (document.form.r_check_out.value.length != 2) {
    alert("시간은 2자리로 입력해주세요 \n ex) 오전2시 = 02 , 오후3시 = 15");
    form.r_check_out.focus();
    return;
  }
  if (document.form.r_guests.value == "") {
    alert("최대 수용 가능 인원을 입력해주세요");
    form.r_guests.focus();
    return;
  }
  if (document.form.r_description.value == "") {
