...
<html>
	...
	<body>
		<%
			...
			String refundPrice = NumberUtil.wonFormatter.format(Double.parseDouble(request.getAttribute("refundPrice").toString()) * nights);
		%>
			...
			<article class="reserve">
				...
				<aside class="aside">
					<div class="bills">
						...
						<section class="delete_info" id="deleteInfo">
