...
<body>
<%
	List<RoomReserve> reserves = (ArrayList<RoomReserve>) request.getAttribute("rooms");
	List<RoomReserve> upcoming = new ArrayList<RoomReserve>();
	List<RoomReserve> past =  new ArrayList<RoomReserve>();
...
%>
	...
	<div class="wrap">
		<section class="trip_before">
			...
			<main class="main">
			<%
				for (RoomReserve reserve: upcoming) {
			%>
