...
},{"./..\\img\\thumbnail1.jpg":[["thumbnail1.531579ca.jpg","src/img/thumbnail1.jpg"],"src/img/thumbnail1.jpg"],"_css_loader":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/js/index.js":[function(require,module,exports) {
"use strict";
...
var getCalendarHTML = function getCalendarHTML(year, month) {
  var setDate = new Date(year, month - 1, 1);
  var firstDayName = setDate.getDay(); //  0~6

  var lastDay = new Date(today.getFullYear(), today.getMonth() + 1, 0).getDate();
  var startDayCount = 1;
  var calHtml = "<div class=\"calendar_month\">".concat(month, "\uC6D4 ").concat(year, "</div>");
    ...
    for (var j = 0; j < 7; j++) {
      ...
      if (i == 0 && j < firstDayName) {
        calHtml += "<div class=\"calendar_day\"><span></span></div>";
          ...
          calHtml += "<div class=\"calendar_day\"><span id=\"".concat(year, "-").concat(month, "-").concat(setFixDayCount(startDayCount++), "\">").concat(startDayCount, "</span></div>");
        }
    }
...
document.querySelector("#curCalendar").insertAdjacentHTML("beforeend", getCalendarHTML(today.getFullYear(), setMonthCount(today.getMonth())));
document.querySelector("#nextCalendar").insertAdjacentHTML("beforeend", getCalendarHTML(today.getFullYear(), setMonthCount(today.getMonth() + 1)));

var onClickNextMonthBtn = function onClickNextMonthBtn() {
  console.log("next month");
};

var onClickPrevMonthBtn = function onClickPrevMonthBtn() {
  console.log("previous month");
};

var onClickFormExitBtn = function onClickFormExitBtn(event) {
  event.preventDefault();
  var form = document.querySelector("#reservationForm");
  form.style.display = "none";
};

var openReservationForm = function openReservationForm(event) {
  if (event.target.closest("#reservationBox") !== null || event.target.closest("#reservationBtn") !== null) {
    var form = document.querySelector("#reservationForm");
